...
namespace Resux.GamePlay
{
    ...
    public class NormalJudgeNote : BaseJudgeNote
    {
        ...
        public NormalJudgeNote(JudgeNoteInfo judgeNoteInfo, bool isMulti)
        {
            ...
            this.judgePos = judge.judgePosition;
            ...
            FirstJudgePos = scaledJudgePos = judgePos;
        ...
        protected override void SendJudgeResult(JudgeResult result, PerfectType perfectType)
        {
            ...
            void OnJudgeOver()
            {
                if (isValidResult)
                {
                    ...
                    // 显示特效
                    ShowEffect(result, perfectType, scaledJudgePos);
                }
            ...
            if (JudgeType == JudgeType.Flick)
            {
                ...
                GamePlayer.Instance.StartCoroutine(
                    CoroutineUtils.DelayExecute(OnJudgeOver, (judgeTime - currentTime) / 1000.0f)
                );
            }
            else
            {
