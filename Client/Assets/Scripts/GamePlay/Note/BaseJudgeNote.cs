...
namespace Resux.GamePlay
{
    ...
    public class BaseJudgeNote : IJudgeNote
    {
        ...
        public static ObjectPool<UI.UIFrameAnimation> effectPool;
        public static ObjectPool<UI.UIFrameAnimation> holdEffectPool;
        ...
        public virtual bool Judge(TouchInputInfo touch)
        {
        ...
        {
            // bad的判定范围就是判定区间
            maxJudgeRange = GameConfigs.JudgeSetting[JudgeType][JudgeResult.Bad];
            minJudgeRange = GameConfigs.JudgeSetting[JudgeType][JudgeResult.PERFECT];
        ...
        protected virtual void ShowEffect(JudgeResult result, PerfectType perfectType, Vector2 position)
        {
            ...
            var elEffect = GamePlayer.Instance.GetELEffect(perfectType);
            ...
            elEffect.transform.position = position;
            elEffect.SetActive(true);
        }
