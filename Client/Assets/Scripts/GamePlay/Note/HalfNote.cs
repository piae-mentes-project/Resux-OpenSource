...
namespace Resux.GamePlay
{
    ...
    public class HalfNote
    {
        ...
        public static ObjectPool<SpriteRenderer> notePool;
        public static ObjectPool<HoldLineRenderer> holdLinePool;

        private static Dictionary<HalfType, Dictionary<JudgeType, Sprite>> SpriteDic;
        ...
        static HalfNote()
        {
            ...
            {
                SpriteDic[HalfType.UpHalf].Add(type, Resources.Load<Sprite>($"{Assets.AssetsFilePathDM.HalfNoteImagePath_Assets}/{type}_Up"));
                SpriteDic[HalfType.DownHalf].Add(type, Resources.Load<Sprite>($"{Assets.AssetsFilePathDM.HalfNoteImagePath_Assets}/{type}_Down"));
            }

            // 多押和默认预制体
            MultiPressMaterial = Resources.Load<Material>($"{Assets.AssetsFilePathDM.MaterialPath_Assets}/MultiPress");
        ...
        public HalfNote(NoteInfo info, JudgeType judgeType, bool isMulti, bool showHoldPath)
        {
            ...
            disappearTime = info.noteMoveInfo.endTime + info.holdPath.Count * 10 + (int)(GameConfigs.JudgeSetting[judgeType][JudgeResult.Bad].y + 0.5f);
            holdPosIndex = 0;
            scaleOffset = 0.3f;
        }
        ...
        public void Update(int t)
        {
            ...
            if (lastFrame > 0 && lastFrame < length)
            {
                ...
                note.transform.position = lastPos;
            }
        }
        ...
        public void ScaleSmall()
        {
            ...
            CoroutineUtils.RunPerDelayTime(
                action: (count) =>
                {
        ...
        public void MultiScale(float multi)
        {
            ...
            else
            {
                ...
                Logger.Log($"x: {multi}, y: {addMulti}", Color.green);
        ...
        private void GetNoteObject()
        {
            ...
            note.transform.position = posList[0];
